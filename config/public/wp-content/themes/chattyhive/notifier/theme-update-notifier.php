...
function update_notifier_menu() {  
	...
	if(version_compare($theme_data->Version, $xml->latest) == -1) {
		add_theme_page( $theme_data->Name . 'Theme Updates', $theme_data->Name . '<span class="update-plugins count-1"><span class="update-count">Update</span></span>', 'administrator', strtolower($theme_data->Name) . '-updates', 'update_notifier'); // 100% safe
	}
}  
...
function update_notifier() { 
	...
	<div class="wrap">
        ...
        <img style="float: left; margin: 0 20px 20px 0; border: 1px solid #ddd;" src="<?php echo get_template_directory_uri() . '/screenshot.png'; ?>" width="300" height="225" />
        
        <div id="instructions" style="max-width: 800px;">
            <h3>Update Instructions</h3>
            <p><strong>Please note:</strong> make a <strong>backup</strong> of the Theme inside your WordPress installation folder <strong>/wp-content/themes/<?php echo strtolower($theme_data->Name); ?>/</strong>. To update the Theme, login to your FameThemes account, re-download the theme like you did when you bought it.</p>
