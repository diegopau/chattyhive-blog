		...
		<div class="ft-bpost">
			...
			<div class="ft-arlist">
				<div class="ft-arrcposts">
					...
					<?php query_posts( 'showposts=30' ); ?><?php if ( have_posts() ) : ?>
					<ul>
				...
				<div class="ft-arpposts">
					...
					<?php $year = date('Y'); query_posts('post_type=post&posts_per_page=30&orderby=comment_count&order=DESC&year=' . $year . ''); ?><?php if ( have_posts() ) : ?>
					<ul>
					<?php while (have_posts()) : the_post(); ?>
						<li>
							<article id="post-<?php the_ID(); ?>-recent" class="widget-post">
