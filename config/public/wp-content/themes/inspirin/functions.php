...
function ft_theme_js() {
	...
	if(!is_admin()) {
		...
		wp_register_script( 'header_shrink', get_template_directory_uri() . '/js/header_shrink.js', array('jquery'), '1.0.0', true );
...
function ft_theme_style()  {  
	...
	wp_register_style( 'google-fonts', 'http://fonts.googleapis.com/css?family=Bitter:400,700', array(), null ); 
