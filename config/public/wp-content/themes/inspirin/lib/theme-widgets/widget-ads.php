...
function ft_load_ads_widgets() {
	register_widget( 'FT_Ads' );
}

add_action( 'widgets_init', 'ft_load_ads_widgets' );

/* ==  Widget ==============================*/

class FT_Ads extends WP_Widget {
...
/* -------------- WIDGET SETUP -------------- */
	...
	function FT_Ads() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'ft_ads_widget', 'description' => __('A widget that displays 125x125 ads.', 'ft') );

		/* Widget control settings */
		$control_ops = array('id_base' => 'ft_ads_widget');

		/* Create the widget */
		$this->WP_Widget( 'ft_ads_widget', __('WFT - 125x125 Ads', 'ft'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		echo '<div class="ads-200 clearfix">';
		echo '<ul>';

		/* DISPLAY AD 1. */
		if ( $ad1 )
			$ads[] = '<li><a target="_blank" href="' . $link1 . '"><img src="' . $ad1 . '" width="125" height="125" alt="Banner 1" /></a></li>';
		/* DISPLAY AD 2. */
		if ( $ad2 )
			$ads[] = '<li><a target="_blank" href="' . $link2 . '"><img src="' . $ad2 . '" width="125" height="125" alt="Banner 2" /></a></li>';
		/* DISPLAY AD 3. */
		if ( $ad3 )
			$ads[] = '<li><a target="_blank" href="' . $link3 . '"><img src="' . $ad3 . '" width="125" height="125" alt="Banner 3" /></a></li>';
		/* DISPLAY AD 4. */
		if ( $ad4 )
			$ads[] = '<li><a target="_blank" href="' . $link4 . '"><img src="' . $ad4 . '" width="125" height="125" alt="Banner 4" /></a></li>';
		/* DISPLAY AD 5. */
		if ( $ad5 )
			$ads[] = '<li><a target="_blank" href="' . $link5 . '"><img src="' . $ad5 . '" width="125" height="125" alt="Banner 5" /></a></li>';
		/* DISPLAY AD 6. */
		if ( $ad6 )
			$ads[] = '<li><a target="_blank" href="' . $link6 . '"><img src="' . $ad6 . '" width="125" height="125" alt="Banner 6" /></a></li>';
	...
	$instance = wp_parse_args( (array) $instance, $defaults ); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad1' ); ?>"><?php _e('Ad 1 image url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link1' ); ?>"><?php _e('Ad 1 link url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad2' ); ?>"><?php _e('Ad 2 image url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link2' ); ?>"><?php _e('Ad 2 link url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad3' ); ?>"><?php _e('Ad 3 image url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link3' ); ?>"><?php _e('Ad 3 link url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad4' ); ?>"><?php _e('Ad 4 image url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link4' ); ?>"><?php _e('Ad 4 link url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad5' ); ?>"><?php _e('Ad 5 image url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link5' ); ?>"><?php _e('Ad 5 link url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'ad6' ); ?>"><?php _e('Ad 6 image url:', 'ft') ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'link6' ); ?>"><?php _e('Ad 6 link url:', 'ft') ?></label>
		...
		<!-- RANDOMIZE? -->
		<p>
			<label for="<?php echo $this->get_field_id( 'random' ); ?>"><?php _e('Randomize ads order?', 'ft') ?></label>
